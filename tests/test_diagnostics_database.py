...
class CanToolsDiagnosticsDatabaseTest(unittest.TestCase):
    ...
    def test_be_example_cdd_repr(self):
        ...
        self.assertEqual(
            ...
            "  data('Resistance', 23, 16, 'big_endian', 10, 0, 0, 255, 'Ohm', None)\n"
            "\n"
            "did('SawTooth', 0x00f4)\n"
            "  data('ampl', 7, 8, 'big_endian', 1, 0, 0, 255, 'None', None)\n"
            "  data('period', 15, 8, 'big_endian', 20, 0, 0, 255, 'sec', None)\n"
            "  data('value', 23, 8, 'big_endian', 1, 0, 0, 255, 'None', None)\n"
            "\n"
            "did('Sine', 0x00f3)\n"
            "  data('ampl', 7, 8, 'big_endian', 1, 0, 0, 255, 'None', None)\n"
            "  data('period', 15, 8, 'big_endian', 20, 0, 0, 255, 'sec', None)\n"
            ...
            "  data('Number', 7, 8, 'big_endian', 1, 0, 0, 255, 'None', None)\n"
    ...
    def test_le_example_cdd_repr(self):
        ...
        self.assertEqual(
            ...
            "  data('Resistance', 16, 16, 'little_endian', 10, 0, 0, 255, 'Ohm', None)\n"
            "\n"
            "did('SawTooth', 0x00f4)\n"
            "  data('ampl', 0, 8, 'little_endian', 1, 0, 0, 255, 'None', None)\n"
            "  data('period', 8, 8, 'little_endian', 20, 0, 0, 255, 'sec', None)\n"
            "  data('value', 16, 8, 'little_endian', 1, 0, 0, 255, 'None', None)\n"
            "\n"
            "did('Sine', 0x00f3)\n"
            "  data('ampl', 0, 8, 'little_endian', 1, 0, 0, 255, 'None', None)\n"
            "  data('period', 8, 8, 'little_endian', 20, 0, 0, 255, 'sec', None)\n"
            ...
            "\n"
            "did('FaultMemory_identified', 0x00f2)\n"
            "  data('Number', 0, 8, 'little_endian', 1, 0, 0, 255, 'None', None)\n"
